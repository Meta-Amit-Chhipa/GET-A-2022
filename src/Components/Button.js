...
export class ButtonPress extends React.Component{
    ...
    render(){
        return(
            <div>
              ...
              <button value="3" onClick={e => this.props.onClick(e.target.value)}>3</button><br/>
              ...
              <button value="6" onClick={e => this.props.onClick(e.target.value)}>6</button><br/>
              ...
              <button value="9" onClick={e => this.props.onClick(e.target.value)}>9</button><br/>
